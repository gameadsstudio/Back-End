...
namespace api.Migrations
{
    ...
    [Migration("20210427144720_ChangeOrganizationsDateModificationToDateUpdate")]
    partial class ChangeOrganizationsDateModificationToDateUpdate
    {
            ...
            modelBuilder.Entity("api.Models.User.UserModel", b =>
                {
                    ...
                    b.HasIndex("OrgId")
                        .HasDatabaseName("ix_user_org_id");
            ...
            modelBuilder.Entity("api.Models.User.UserModel", b =>
                {
                    b.HasOne("api.Models.Organization.OrganizationModel", "Organization")
                        .WithMany("Users")
                        .HasForeignKey("OrgId")
                        .HasConstraintName("fk_user_organization_org_id");
