...
namespace api.Migrations
{
    ...
    [Migration("20210907191659_front-feedback")]
    partial class frontfeedback
    {
            ...
            modelBuilder.Entity("api.Models.Tag.TagModel", b =>
                {
                    ...
                    b.HasIndex("MediaModelId")
                        .HasDatabaseName("ix_tag_media_model_id");
            ...
            modelBuilder.Entity("api.Models.Tag.TagModel", b =>
                {
                    b.HasOne("api.Models.Media.MediaModel", null)
                        ...
                        .HasConstraintName("fk_tag_media_media_model_id");
                });
