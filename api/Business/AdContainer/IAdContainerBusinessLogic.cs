...
namespace api.Business.AdContainer
{
    public interface IAdContainerBusinessLogic
    {
        ...
        (int page, int pageSize, int totalItemCount, List<AdContainerPublicDto> adContainers) GetAdContainers(PagingDto paging, string orgId, ConnectedUser currentUser);
